...
func (h Hero) checkCondition() {
	if h.weakened == true {
		fmt.Println("%s is weakened", h.name)
	}
	if h.slowed == true {
		fmt.Println("%s is slowed", h.name)
	}
	if h.imbued == true {
		fmt.Println("%s is imbued", h.name)
	}
}
...
func (e Enemy) checkCondition() {
	if e.weakened == true {
		fmt.Println("%s is weakened", e.class)
	}
	if e.slowed == true {
		fmt.Println("%s is slowed", e.class)
	}
	if e.repelled == true {
		fmt.Println("%s is repelled", e.class)
	}
}
